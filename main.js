...
function getQuantityElements(heightElement) {
    return document.documentElement.clientHeight / heightElement + 0.6;
...
function playGame() {
    ...
    let a = 0;
    if(setting.score > 2000 && a===0) {
        ++setting.speed;
        ++setting.level;
    } else if (setting.score > 5000 && a === 1){
        ++setting.speed;
        ++setting.level;
    } else if (setting.score > 10000 && a === 2){
        ++setting.speed;
        ++setting.level;
    }
